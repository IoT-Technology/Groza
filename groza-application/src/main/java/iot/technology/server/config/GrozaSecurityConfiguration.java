...
import iot.technology.server.dao.audit.AuditLogLevelFilter;
import iot.technology.server.exception.GrozaErrorResponseHandler;
import iot.technology.server.service.security.auth.jwt.*;
import iot.technology.server.service.security.auth.jwt.extractor.TokenExtractor;
import iot.technology.server.service.security.auth.rest.RestAuthenticationProvider;
import iot.technology.server.service.security.auth.rest.RestLoginProcessingFilter;
import iot.technology.server.service.security.auth.rest.RestPublicLoginProcessingFilter;
...
public class GrozaSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired private GrozaErrorResponseHandler restAccessDeniedHandler;
